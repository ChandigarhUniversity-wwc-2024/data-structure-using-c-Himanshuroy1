...
def notif():
    ...
    sender_email = "himanshus2royhy@gmail.com"  # Enter your address
    receiver_email = "dakshj287@gmail.com"  # Enter receiver address
    password = "vellala@2999"
    message = """\
    Subject: Hi, Himanshu this side
...
vinni_image = face_recognition.load_image_file("/home/ise/SIH/app/known/himanshu.jpg") 
vinni_face_encoding = face_recognition.face_encodings(vinni_image)[0]

shan_image = face_recognition.load_image_file("/home/ise/SIH/app/known/shashank.jpg") 
shan_face_encoding = face_recognition.face_encodings(shan_image)[0]

deep_image = face_recognition.load_image_file("/home/ise/SIH/app/known/ritesh.jpg") 
deep_face_encoding = face_recognition.face_encodings(deep_image)[0]

madam = face_recognition.load_image_file("/home/ise/SIH/app/known/daksh.jpg") 
